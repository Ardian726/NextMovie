...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md shadow-sm" style="background-color: #0d6efd;">
            <div class="container">
                <a class="blog-header-logo text-body-emphasis text-decoration-none"
                    href="{{ url('/') }}">NextMovie<span class="text-danger">.</span></a>
        ...
        <main class="py-4">
            <div class="container mb-4">
                <a class="btn btn-secondary" href="/home">Dashborad</a>
            </div>
            @yield('content')
        </main>
    </div>
